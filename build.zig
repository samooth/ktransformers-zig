...
pub fn build(b: *std.Build) void {
    ...
    // Suite 6e: math helpers (kt_apply_swiglu/rms_norm/rope + kt_softmax)
    RunTest.run(b, test_step, "tests/kernels/math_helpers_capi_tests.zig", "src/main.zig", target, optimize);
